...
import jeep2x from "../../images/jeep2x.png"
...
<div className='flex items-center justify-end mt-3 w-1/4'>
    ...
    <div className=' flex flex-col justify-center bg-white product-img relative' style={{ borderRadius : "20px" }}>
        <Image width={393} height={525} src={jeep2x}></Image>
    ...
    <div style={{ borderRadius: '20px',background : "#161A42 0% 0% no-repeat padding-box" }} className='w-11/12 p-5 flex lg:flex-row flex-col mt-5 lg:mt-0'>
        <div className='w-7/12 flex flex-col items-center lg:items-start'>
            <div className='flex'>
                ...
                <p className='relative bottom-1' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>JEEP</p>
                </div>
            ...
            <div style={{ width : "285px" }} className='mt-3 text-white p-6 lg:p-0'>
                <p style={{fontFamily:"Poppins" }}>Jeeps are a species of mysterious and mystical creatures from Africa with a number of abilities, that originate from a four-dimensional world. The most famous member of this species is Eugene the Jeep. Jeeps are playful creatures but also posses a mysterious level of knowledge, knowing the answers to a lot of things around them. As they cannot speak, other than saying the word « Jeep », they tend to communicate with others via body language, showing that they have a decent understanding of human languages. Their diet consists only of orchids.</p>
            </div>
