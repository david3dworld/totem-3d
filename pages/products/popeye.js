    ...
    <div style={{ borderRadius: '20px',background : "#161A42 0% 0% no-repeat padding-box" }} className='w-11/12 p-5 flex lg:flex-row flex-col mt-5 lg:mt-0'>
        <div className='w-7/12 flex flex-col items-center lg:items-start'>
            <div className='flex'>
                ...
                <p className='relative bottom-1' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>POPEYE</p>
                </div>
            ...
            <div style={{ width : "285px" }} className='mt-3 text-white p-6 lg:p-0'>
                <p style={{fontFamily:"Poppins" }}>As a child, we looked up to Popeye, and wanted to be like him. Now, we have the option to be him! Extremely tough, with bulging muscles and a rugged look, Popeye is recognizable to everyone, everywhere. Popeye adds incredible value to any collectible collection, and with TOTEM figurines, you’ll have the ability to show off your new Popeye figurine to avid fans around the world to admire.</p>
            </div>
        ...
        <div className='text-md flex flex-col items-center lg:items-start'>
                ...
                <p className='relative ' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>6,756/10,0000</p>
                </div>
