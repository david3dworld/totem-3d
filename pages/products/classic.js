...
import stormBlack from "../../images/storm-black.png"
...
<div className='flex items-center justify-center mt-3 w-full'>
    ...
    <div className=' flex flex-col justify-center bg-white product-img relative' style={{ borderRadius : "20px" }}>
        <Image width={393} height={525} src={white}></Image>
    ...
    <div style={{ borderRadius: '20px',background : "#161A42 0% 0% no-repeat padding-box" }} className='w-11/12 p-5 flex lg:flex-row flex-col mt-5 lg:mt-0'>
        <div className='w-7/12 flex flex-col items-center lg:items-start'>
            <div className='flex'>
                ...
                <p className='relative bottom-1' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>CLASSIC</p>
                </div>
            ...
            <div style={{ width : "285px" }} className='mt-3 text-white p-6 lg:p-0'>
                <p style={{fontFamily:"Poppins" }}>He’s a classic. He’s the original, white-suited Stormtrooper that has taken over the internet with his mischievous behavior and off-duty adventures. A famously threatening yet paradoxically harmless character taken straight out of one of the greatest space sagas of the 20th century that now spends his downtime getting into all sorts of trouble. Instantly recognizable, this popular Original Stormtrooper is now available to be added to your digital collection as a unique TOTEM figurine. Upgrade your collection with this exclusive fan favorite.</p>
            </div>

            <div className='lg:mt-5'>
                <div className='flex items-center'>
                    <p className='text-white'>Price</p>
                    <p className='text-2xl ml-2' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>$59</p>
        ...
        <div className='text-md flex flex-col items-center lg:items-start'>
                ...
                <p className='relative ' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>6,756/16,0000</p>
                </div>
