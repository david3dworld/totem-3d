...
<div className='flex items-center justify-center mt-3 w-full'>
    ...
    <div className=' flex flex-col justify-center bg-white product-img relative' style={{ borderRadius : "20px" }}>
        <Image width={393} height={525} src={yellow}></Image>
    ...
    <div style={{ borderRadius: '20px',background : "#161A42 0% 0% no-repeat padding-box" }} className='w-11/12 p-5 flex lg:flex-row flex-col mt-5 lg:mt-0'>
        <div className='w-7/12 flex flex-col items-center lg:items-start'>
            <div className='flex'>
                ...
                <p className='relative bottom-1' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>GOLD</p>
                </div>
                ...
                <p style={{fontFamily:"Poppins" }} className='relative bottom-1 text-white'>ULTRA RARE</p>
                </div>
            </div>

            <div style={{ width : "285px" }} className='mt-3 text-white p-6 lg:p-0'>
                <p style={{fontFamily:"Poppins" }}>Discover the Original Gold Stormtrooper. The sexiest Stormtrooper of them all. Poised to attack at a moment’s notice, armed with his two laser pistols. This isn’t a character to take lightly! The Gold Stormtrooper is available as an ultra-limited edition TOTEM figurine. This figurine is a serious upgrade, the only thing left to do is add it to your TOTEM digital collection.</p>
            </div>

            <div className='lg:mt-5'>
                <div className='flex items-center'>
                    <p className='text-white'>Price</p>
                    <p className='text-2xl ml-2' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>$149</p>
        ...
        <div className='text-md flex flex-col items-center lg:items-start'>
                ...
                <p className='relative ' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>1,756/3,000</p>
                </div>
