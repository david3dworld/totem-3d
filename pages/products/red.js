...
<div className='flex items-center justify-center mt-3 w-full'>
    ...
    <div className=' flex flex-col justify-center bg-white product-img relative' style={{ borderRadius : "20px" }}>
        <div className='ml-2'>
        <Image width={393} height={525} src={red2x}></Image>
        </div>
    ...
    <div style={{ borderRadius: '20px',background : "#161A42 0% 0% no-repeat padding-box" }} className='w-11/12 p-5 flex lg:flex-row flex-col mt-5 lg:mt-0'>
        <div className='w-7/12 flex flex-col items-center lg:items-start'>
            <div className='flex'>
                ...
                <p className='relative bottom-1' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>RED</p>
                </div>
            ...
            <div style={{ width : "285px" }} className='mt-3 text-white p-6 lg:p-0'>
                <p style={{fontFamily:"Poppins" }}>The Original Stormtrooper, RED EDITION. His shimmering scarlet armor and badass demeanor earn his right to RARE status! He’s just waiting for someone to look at him slightly wrong to spring into action, weapon ready. He’s not one to be scared easily and probably looks to start trouble himself, he’s the Original RED Stormtrooper available as an exclusive TOTEM figurine. True fans won’t miss this one!</p>
            </div>

            <div className='lg:mt-5'>
                <div className='flex items-center'>
                    <p className='text-white'>Price</p>
                    <p className='text-2xl ml-2' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>$79</p>
        ...
        <div className='text-md flex flex-col items-center lg:items-start'>
                ...
                <p className='relative ' style={{ color : "#0EA8D6",fontFamily:"Poppins" }}>6,756/11,0000</p>
                </div>
